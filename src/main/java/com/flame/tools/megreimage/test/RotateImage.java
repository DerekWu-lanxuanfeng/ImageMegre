 ...
 * @Product: MagreImage 
 * @File: com.flame.tools.megreimage.RotateImage.java
 * @Description: 旋转图片
 * @Create: DerekWu  2016年4月18日 上午9:51:29 
 * @version: V1.0 
 */
...
//		Assert.assertTrue(ImageIO.write(des, "jpg", new File("d:/dog2.jpg")));
			ImageIO.write(des, "png", new File("e://my30.png"));

			// bigger angel
			des = RotateImage.Rotate(src, 150);
//		Assert.assertNotNull(des);
//		Assert.assertTrue(ImageIO.write(des, "jpg", new File("d:/dog3.jpg")));
			ImageIO.write(des, "png", new File("e://my150.png"));

			// bigger angel
			des = RotateImage.Rotate(src, 270);
//		Assert.assertNotNull(des);
//		Assert.assertTrue(ImageIO.write(des, "jpg", new File("e://my.png")));
			ImageIO.write(des, "png", new File("e://my270.png"));
		} catch (IOException e) {
